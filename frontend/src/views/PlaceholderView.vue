...
const title = computed(() => {
  ...
  return typeof metaTitle === 'string' && metaTitle.length > 0 ? metaTitle : 'Página'
})

const icon = computed(() => {
  const metaIcon = route.meta.icon
  return typeof metaIcon === 'string' && metaIcon.length > 0 ? metaIcon : 'lucide:layout'
})
</script>
